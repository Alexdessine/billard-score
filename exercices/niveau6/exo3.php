    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-8">
                <div>
                    <img src="../../img/exo_niv_1/exo_3.jpg" alt="" class="exoImage">
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-xl-4">
                <h5>Instructions</h5>
                <p>Réaliser 5 coups en commençant dans la zone indiquées<br>
                La bille blanche ne doit pas être empochée<br>
                <strong>Score :</strong> 1 point par bille pochée<br>
                <strong>5 Points maximums</strong><br>
                Réussissez cet exercice à 5 reprises <br>
                Score maximum de l'exercice : <strong>25 points</strong>
                <br>
                <br>
                ...
                ?>
                <form action="/exercices/niveau1/traitement/exo3traitement.php?client=<?=$client?>" class="form-control" method="POST">
                    <label for="">Essai #1</label>
                    <input type="number" name="essai1" min="0" max="5"><br>
                    <label for="">Essai #2</label>
                    <input type="number" name="essai2" min="0" max="5"><br>
                    <label for="">Essai #3</label>
                    <input type="number" name="essai3" min="0" max="5"><br>
                    <label for="">Essai #4</label>
                    <input type="number" name="essai4" min="0" max="5"><br>
                    <label for="">Essai #5</label>
                    <input type="number" name="essai5" min="0" max="5"><br><br>
