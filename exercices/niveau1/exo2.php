    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-8">
                <div>
                    <img src="../../img/exo_niv_1/exo_2.jpg" alt="" class="exoImage">
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-xl-4">
                ...
                <strong>3 Points maximum</strong><br>
                ...
                ?>
                <form action="/exercices/niveau1/traitement/exo2traitement.php?client=<?=$client?>" class="form-control" method="POST">
