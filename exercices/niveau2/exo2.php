    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-8">
                <div>
                    <img src="../../img/exo_niv_2/exo_2.jpg" alt="" class="exoImage">
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-xl-4">
                ...
                <strong>Score :</strong> 1 point par bille empochée <br>
                ...
                ?>
                <form action="/exercices/niveau2/traitement/exo2traitement.php?client=<?=$client?>" class="form-control" method="POST">
