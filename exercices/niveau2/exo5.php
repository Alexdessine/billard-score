    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-8">
                <div>
                    <img src="../../img/exo_niv_2/exo_5.jpg" alt="" class="exoImage">
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-xl-4">
                <h5>Instructions</h5>
                <p>Empocher les billes de couleurs 3 fois de suite sur chaque emplacement<br>
                1 point par bille empochée<br>
                la blanche empochée n'est pas considérée comme une faute<br>
                <strong>12 Points maximum</strong><br>
                Réussissez cet exercice à 5 reprises <br>
                Score maximum de l'exercice : <strong>60 points</strong>
                <br>
                <br>
                ...
                ?>
                <form action="/exercices/niveau2/traitement/exo5traitement.php?client=<?=$client?>" class="form-control" method="POST">
                    <label for="">Essai #1</label>
                    <input type="number" name="essai1" min="0" max="12"><br>
                    <label for="">Essai #2</label>
                    <input type="number" name="essai2" min="0" max="12"><br>
                    <label for="">Essai #3</label>
                    <input type="number" name="essai3" min="0" max="12"><br>
                    <label for="">Essai #4</label>
                    <input type="number" name="essai4" min="0" max="12"><br>
                    <label for="">Essai #5</label>
                    <input type="number" name="essai5" min="0" max="12"><br><br>
