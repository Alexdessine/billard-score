    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-8">
                <div>
                    <img src="../../img/exo_niv_2/exo_4.jpg" alt="" class="exoImage">
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-xl-4">
                ...
                ?>
                <form action="/exercices/niveau2/traitement/exo4traitement.php?client=<?=$client?>" class="form-control" method="POST">
...
<section class="bouton_exercice">
    <div class="precedent">
        <a href="exo3.php?client=<?=$client?>">Exercice précédent</a>
    </div>
    <div class="precedent">
