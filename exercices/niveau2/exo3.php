    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-8">
                <div>
                    <img src="../../img/exo_niv_2/exo_3.jpg" alt="" class="exoImage">
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-xl-4">
                <h5>Instructions</h5>
                <p>Empocher la bille rouge avec un coup nature et appui bande. Arrêter la bille blanche derrière la ligne pointillée. <br>
                Après avoir empôchée la bille de couleur, si la blanche ne s'arrête pas dans la zone délimitée par la ligne pointillée vous ne marquez qu'un seul point et vous n'empochez pas la noire.<br>
                La bille blanche ne doit pas être empochée <br>
                <strong>Score :</strong> 1 point par bille pochée<br>
                <strong>10 Points maximum</strong><br>
                Réussissez cet exercice à 5 reprises <br>
                Score maximum de l'exercice : <strong>50 points</strong>
                <br>
                <br>
                ...
                ?>
                <form action="/exercices/niveau2/traitement/exo3traitement.php?client=<?=$client?>" class="form-control" method="POST">
                    <label for="">Essai #1</label>
                    <input type="number" name="essai1" min="0" max="10"><br>
                    <label for="">Essai #2</label>
                    <input type="number" name="essai2" min="0" max="10"><br>
                    <label for="">Essai #3</label>
                    <input type="number" name="essai3" min="0" max="10"><br>
                    <label for="">Essai #4</label>
                    <input type="number" name="essai4" min="0" max="10"><br>
                    <label for="">Essai #5</label>
                    <input type="number" name="essai5" min="0" max="10"><br><br>
...
<section class="bouton_exercice">
    <div class="precedent">
        <a href="exo2.php?client=<?=$client?>">Exercice précédent</a>
    </div>
    <div class="precedent">
        <a href="exo4.php?client=<?=$client?>">Exercice suivant</a>
    </div>
</section>
</body>
