    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-8">
                <div>
                    <img src="../../img/exo_niv_3/exo_2.jpg" alt="" class="exoImage">
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-xl-4">
                <h5>Instructions</h5>
                <p>Empocher 3 x 4 billes et arrêter la bille blanche dans la zone<br>
                La bille blanche ne doit pas être empochée<br>
                <strong>Score :</strong> 1 point par bille empochée et bille blanche stoppée dans la zone <br>
                ...
                ?>
                <form action="/exercices/niveau3/traitement/exo2traitement.php?client=<?=$client?>" class="form-control" method="POST">
