    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-8">
                <div>
                    <img src="../../img/exo_niv_3/exo_3.jpg" alt="" class="exoImage">
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-xl-4">
                <h5>Instructions</h5>
                <p>Empocher 5 x 2 billes avec une quantité de bille 3/4<br>
                ...
                ?>
                <form action="/exercices/niveau3/traitement/exo3traitement.php?client=<?=$client?>" class="form-control" method="POST">
