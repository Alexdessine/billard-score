    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-8">
                <div>
                    <img src="../../img/exo_niv_3/exo_4.jpg" alt="" class="exoImage">
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-xl-4">
                <h5>Instructions</h5>
                <p>Exécuter 5 fois le Kick Shot A<br>
                Exécuter 5 fois le Kick Shot B<br>
                1 point par kick shot réussi<br>
                ...
                ?>
                <form action="/exercices/niveau3/traitement/exo4traitement.php?client=<?=$client?>" class="form-control" method="POST">
